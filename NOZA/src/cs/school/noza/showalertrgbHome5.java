...
import android.widget.TextView;
public class showalertrgbHome5 extends Activity {
...
services.setOnClickListener(new OnClickListener() {
		    ...
		    @Override
				public void onClick(View v) {
					 ...
					 Intent intent = new Intent(getApplicationContext(),showalertrgb5A.class);
...
corruption.setOnClickListener(new OnClickListener() {
    ...
    @Override
		public void onClick(View v) {
			 ...
			 Intent intent = new Intent(getApplicationContext(),showalertrgb5B.class);
	    	    startActivity(intent);
...
inquiry.setOnClickListener(new OnClickListener() {
    ...
    @Override
		public void onClick(View v) {
			 ...
			 Intent intent = new Intent(getApplicationContext(),showalertrgb5C.class);
	    	    startActivity(intent);
