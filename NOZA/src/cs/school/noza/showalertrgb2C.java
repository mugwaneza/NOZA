...
import android.widget.TextView;
public class showalertrgb2C extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertrgb2);
		 ...
		 tl = (TableLayout) findViewById(R.id.maintable);
	        ...
	        final GetDataFromDB2C getdb = new GetDataFromDB2C();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           showalertrgb2C.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertrgb2C.this);
