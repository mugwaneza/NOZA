...
import android.widget.TextView;
public class showalertrgbHome3 extends Activity {
...
services.setOnClickListener(new OnClickListener() {
		    ...
		    @Override
				public void onClick(View v) {
					 ...
					 Intent intent = new Intent(getApplicationContext(),showalertrgb3A.class);
...
corruption.setOnClickListener(new OnClickListener() {
    ...
    @Override
		public void onClick(View v) {
			 ...
			 Intent intent = new Intent(getApplicationContext(),showalertrgb3B.class);
	    	    startActivity(intent);
...
inquiry.setOnClickListener(new OnClickListener() {
    ...
    @Override
		public void onClick(View v) {
			 ...
			 Intent intent = new Intent(getApplicationContext(),showalertrgb3C.class);
	    	    startActivity(intent);
