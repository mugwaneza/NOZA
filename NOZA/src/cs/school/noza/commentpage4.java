...
public class commentpage4 extends Activity {
	  SQLiteDatabase db;
	  ...
	  protected void onCreate(Bundle savedInstanceState) {
	   ...
	   db.execSQL("create table if not exists mytable4(id INTEGER PRIMARY KEY, name varchar, sur_name varchar, DATETIME DEFAULT CURRENT_TIMESTAMP)");
	   }
	    ...
	    if(name.equals("")||sur_name.equals(""))
  {
	    ...
	    db.execSQL("insert into mytable4 values(null,'"+name+"','"+sur_name+"','"+strDate+"')");
	   //display Toast
