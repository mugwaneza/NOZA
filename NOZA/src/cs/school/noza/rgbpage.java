...
public class rgbpage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rgbpage);
...
show.setOnClickListener(new OnClickListener() {
            ...
            @Override
     		public void onClick(View v) {
        		...
        		dialog = ProgressDialog.show(rgbpage.this, "", 
	...
	void login(){
		...
		try{			
			...
			httppost= new HttpPost("http://www.ndanoza.com/noza/validatergb.php"); // make sure the url is correct.
			//add your data
			...
			// edited by alexis from programage ltd.. from here....
			...
			if(response.equalsIgnoreCase("User Found")){
				runOnUiThread(new Runnable() {
				    public void run() {
				    	Toast.makeText(rgbpage.this,"Login Success", Toast.LENGTH_SHORT).show();
				    }
				});
				
				startActivity(new Intent(rgbpage.this, retrievebyinstitutions.class));
			}else{
				showAlert();				
			}
	...
	public void showAlert(){
		rgbpage.this.runOnUiThread(new Runnable() {
		    public void run() {
		    	AlertDialog.Builder builder = new AlertDialog.Builder(rgbpage.this);
