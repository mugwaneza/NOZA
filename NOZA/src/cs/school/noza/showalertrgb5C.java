...
import android.widget.TextView;
public class showalertrgb5C extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertrgb5);
		 ...
		 tl = (TableLayout) findViewById(R.id.maintable);
	        ...
	        final GetDataFromDB5C getdb = new GetDataFromDB5C();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           showalertrgb5C.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertrgb5C.this);
