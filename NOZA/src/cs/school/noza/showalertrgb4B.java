...
import android.widget.TextView;
public class showalertrgb4B extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertrgb4);
		
		 tl = (TableLayout) findViewById(R.id.maintable);
		 
	        final GetDataFromDB4B getdb = new GetDataFromDB4B();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           showalertrgb4B.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertrgb4B.this);
