...
import android.widget.TextView;
public class showalertrgbHome4 extends Activity {
...
services.setOnClickListener(new OnClickListener() {
		    ...
		    @Override
				public void onClick(View v) {
					 ...
					 Intent intent = new Intent(getApplicationContext(),showalertrgb4A.class);
...
corruption.setOnClickListener(new OnClickListener() {
    ...
    @Override
		public void onClick(View v) {
			 ...
			 Intent intent = new Intent(getApplicationContext(),showalertrgb4B.class);
	    	    startActivity(intent);
...
inquiry.setOnClickListener(new OnClickListener() {
    ...
    @Override
		public void onClick(View v) {
			 ...
			 Intent intent = new Intent(getApplicationContext(),showalertrgb4C.class);
	    	    startActivity(intent);
