...
import android.widget.TextView;
public class showalertrgb5A extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertrgb5);
		
		 tl = (TableLayout) findViewById(R.id.maintable);
		 
	        final GetDataFromDB5A getdb = new GetDataFromDB5A();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           showalertrgb5A.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertrgb5A.this);
