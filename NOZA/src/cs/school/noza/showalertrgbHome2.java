...
import android.widget.TextView;
public class showalertrgbHome2 extends Activity {
...
services.setOnClickListener(new OnClickListener() {
		    ...
		    @Override
				public void onClick(View v) {
					 ...
					 Intent intent = new Intent(getApplicationContext(),showalertrgb2A.class);
...
corruption.setOnClickListener(new OnClickListener() {
    ...
    @Override
		public void onClick(View v) {
			 ...
			 Intent intent = new Intent(getApplicationContext(),showalertrgb2B.class);
	    	    startActivity(intent);
...
inquiry.setOnClickListener(new OnClickListener() {
    ...
    @Override
		public void onClick(View v) {
			 ...
			 Intent intent = new Intent(getApplicationContext(),showalertrgb2C.class);
	    	    startActivity(intent);
