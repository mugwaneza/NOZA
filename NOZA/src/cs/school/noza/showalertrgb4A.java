...
import android.widget.TextView;
public class showalertrgb4A extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertrgb4);
		 ...
		 tl = (TableLayout) findViewById(R.id.maintable);
	        ...
	        final GetDataFromDB4A getdb = new GetDataFromDB4A();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           showalertrgb4A.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertrgb4A.this);
