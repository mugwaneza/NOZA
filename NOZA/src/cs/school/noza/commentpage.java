...
public class commentpage extends Activity {
	  ...
	  protected void onCreate(Bundle savedInstanceState) {
	   ...
	   db.execSQL("create table if not exists mytable(id INTEGER PRIMARY KEY, name varchar, sur_name varchar, DATETIME DEFAULT CURRENT_TIMESTAMP)");
	   }
	   ...
	   public void insert(View v)
	   {
	    ...
	    db.execSQL("insert into mytable values(null,'"+name+"','"+sur_name+"','"+strDate+"')");
	   //display Toast
