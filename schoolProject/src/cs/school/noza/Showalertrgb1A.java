...
public class Showalertrgb1A extends Activity {
	...
	StrictMode.setThreadPolicy(policy);
		 ...
		 tl = (TableLayout) findViewById(R.id.maintable);
	        final GetDataFromDB1A getdb = new GetDataFromDB1A();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           Showalertrgb1A.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(Showalertrgb1A.this);
