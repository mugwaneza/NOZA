...
import android.widget.TextView;
public class showalertrgb3A extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertrgb3);
		 ...
		 tl = (TableLayout) findViewById(R.id.maintable);
	        ...
	        final GetDataFromDB3A getdb = new GetDataFromDB3A();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           showalertrgb3A.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertrgb3A.this);
