...
public class Showalertrgb1B extends Activity {
...
StrictMode.setThreadPolicy(policy);
	 ...
	 tl = (TableLayout) findViewById(R.id.maintable);
        final GetDataFromDB1B getdb = new GetDataFromDB1B();
    ...
    public ArrayList<Users> parseJSON(String result) {
        ...
        try {
           ...
           Showalertrgb1B.this.runOnUiThread(new Runnable() {
    		    public void run() {
    		    	AlertDialog.Builder builder = new AlertDialog.Builder(Showalertrgb1B.this);
