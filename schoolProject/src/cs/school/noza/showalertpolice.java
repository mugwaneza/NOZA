...
public class showalertpolice extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertpolice);
		
		
		
		 tl = (TableLayout) findViewById(R.id.maintable);
	        final PoliceGetDataFromDB getdb = new PoliceGetDataFromDB();
	        new Thread(new Runnable() {
	            public void run() {
	                ...
	                runOnUiThread(new Runnable() {
	                    ...
	                    @Override
	                    public void run() {
	                        ArrayList<Users> emergencyalert = parseJSON(data);
	                        addData(emergencyalert);                     
	                    }
	                });
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ArrayList<Users>emergencyalert = new ArrayList<Users>();
	        try {
	            ...
	            for (int i = 0; i < jArray.length(); i++) {
	                ...
	                emergencyalert.add(user);
	            }
	        } catch (JSONException e) {
	            Log.e("log_tag", "Error parsing data " + e.toString());  
	     
	           showalertpolice.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertpolice.this);
	    		    	builder.setTitle("finder warning.");
	    		    	builder.setMessage("Sorry,store is empty!")  
	    		    	       .setCancelable(false)
	    ...
	    public void addData(ArrayList<Users> emergencyalert) {
	 
	        addHeader();
	         
	        for (Iterator i = emergencyalert.iterator(); i.hasNext();) {
	            ...
	            reason.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
	                    LayoutParams.WRAP_CONTENT));
	            reason.setPadding(5, 5, 5, 5);
	            reason.setBackgroundColor(Color.BLACK);
	            ...
	            institution.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
	                    LayoutParams.WRAP_CONTENT));
	            institution.setPadding(5, 5, 5, 5);
	            institution.setTextColor(Color.WHITE);
	            institution.setBackgroundColor(Color.BLACK);
	            Ll = new LinearLayout(this);
	            params = new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
	                    LayoutParams.WRAP_CONTENT);
	            params.setMargins(0, 2, 2, 2);
