...
import android.widget.TextView;
public class showalertrgb3C extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertrgb3);
		
		 tl = (TableLayout) findViewById(R.id.maintable);
		 
	        final GetDataFromDB3C getdb = new GetDataFromDB3C();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           showalertrgb3C.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertrgb3C.this);
