...
import android.widget.TextView;
public class showalertrgb26 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showalertrgb);
		 ...
		 tl = (TableLayout) findViewById(R.id.maintable);
	        ...
	        final GetDataFromDB26 getdb = new GetDataFromDB26();
	    ...
	    public ArrayList<Users> parseJSON(String result) {
	        ...
	        try {
	           ...
	           showalertrgb26.this.runOnUiThread(new Runnable() {
	    		    public void run() {
	    		    	AlertDialog.Builder builder = new AlertDialog.Builder(showalertrgb26.this);
